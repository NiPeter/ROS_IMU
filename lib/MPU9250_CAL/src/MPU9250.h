...
bool _debug;
static volatile bool _isNewData;
...
MPU9250(bool debug = true) : _debug(debug){
        getAres();
        getGres();
        getMres();
}
...
float magCalibration[3] = {0, 0, 0}, magScale[3] = {0, 0, 0},magBias[3] = {0, 0, 0};
// Bias corrections for gyro and accelerometer

int16_t gyroBias[3] = {0, 0, 0}, accelBias[3] = {0, 0, 0};

float accel[3] = {0,0,0},gyro[3]={0,0,0},mag[3]={0,0,0};


public:

void begin(uint8_t int_pin);
...
void getGres();
void getAres();
void readRawAccelData(int16_t *);
void readRawGyroData(int16_t *);
void readRawMagData(int16_t *);
...
bool MPU9250CommunicationTest(void);
bool AK8963CommunicationTest(void);

void initAK8963(float *);
void initMPU9250();
void calibrateMPU9250();
void calibrateAK9863();

void MPU9250SelfTest(void);
